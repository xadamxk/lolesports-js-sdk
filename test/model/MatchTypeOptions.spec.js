...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MatchTypeOptions', function() {
      beforeEach(function() {
        instance = new LolesportsApi.MatchTypeOptions();
      });

      it('should create an instance of MatchTypeOptions', function() {
        // TODO: update the code to test MatchTypeOptions
        expect(instance).to.be.a(LolesportsApi.MatchTypeOptions);
      });
