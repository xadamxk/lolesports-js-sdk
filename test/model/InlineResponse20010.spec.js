...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20010', function() {
      beforeEach(function() {
        instance = new LolesportsApi.InlineResponse20010();
      });

      it('should create an instance of InlineResponse20010', function() {
        // TODO: update the code to test InlineResponse20010
        expect(instance).to.be.a(LolesportsApi.InlineResponse20010);
      });

      it('should have the property navItems (base name: "navItems")', function() {
        // TODO: update the code to test the property navItems
        expect(instance).to.have.property('navItems');
        // expect(instance.navItems).to.be(expectedValueLiteral);
      });
