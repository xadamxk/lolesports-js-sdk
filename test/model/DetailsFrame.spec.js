...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DetailsFrame', function() {
      beforeEach(function() {
        instance = new LolesportsApi.DetailsFrame();
      });

      it('should create an instance of DetailsFrame', function() {
        // TODO: update the code to test DetailsFrame
        expect(instance).to.be.a(LolesportsApi.DetailsFrame);
      });
