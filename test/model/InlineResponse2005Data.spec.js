...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2005Data', function() {
      beforeEach(function() {
        instance = new LolesportsApi.InlineResponse2005Data();
      });

      it('should create an instance of InlineResponse2005Data', function() {
        // TODO: update the code to test InlineResponse2005Data
        expect(instance).to.be.a(LolesportsApi.InlineResponse2005Data);
      });
