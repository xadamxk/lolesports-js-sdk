...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Ranking', function() {
      beforeEach(function() {
        instance = new LolesportsApi.Ranking();
      });

      it('should create an instance of Ranking', function() {
        // TODO: update the code to test Ranking
        expect(instance).to.be.a(LolesportsApi.Ranking);
      });
