...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BracketType', function() {
      beforeEach(function() {
        instance = new LolesportsApi.BracketType();
      });

      it('should create an instance of BracketType', function() {
        // TODO: update the code to test BracketType
        expect(instance).to.be.a(LolesportsApi.BracketType);
      });
