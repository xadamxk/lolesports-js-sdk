...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20014TeamStatsHistories', function() {
      beforeEach(function() {
        instance = new LolesportsApi.InlineResponse20014TeamStatsHistories();
      });

      it('should create an instance of InlineResponse20014TeamStatsHistories', function() {
        // TODO: update the code to test InlineResponse20014TeamStatsHistories
        expect(instance).to.be.a(LolesportsApi.InlineResponse20014TeamStatsHistories);
      });
