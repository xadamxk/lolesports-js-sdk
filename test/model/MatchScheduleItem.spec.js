...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MatchScheduleItem', function() {
      beforeEach(function() {
        instance = new LolesportsApi.MatchScheduleItem();
      });

      it('should create an instance of MatchScheduleItem', function() {
        // TODO: update the code to test MatchScheduleItem
        expect(instance).to.be.a(LolesportsApi.MatchScheduleItem);
      });
