...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfinlineResponse2005DataScheduleEventsItems', function() {
      beforeEach(function() {
        instance = new LolesportsApi.AllOfinlineResponse2005DataScheduleEventsItems();
      });

      it('should create an instance of AllOfinlineResponse2005DataScheduleEventsItems', function() {
        // TODO: update the code to test AllOfinlineResponse2005DataScheduleEventsItems
        expect(instance).to.be.a(LolesportsApi.AllOfinlineResponse2005DataScheduleEventsItems);
      });
