...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfinlineResponse2001DataScheduleEventsItems', function() {
      beforeEach(function() {
        instance = new LolesportsApi.AllOfinlineResponse2001DataScheduleEventsItems();
      });

      it('should create an instance of AllOfinlineResponse2001DataScheduleEventsItems', function() {
        // TODO: update the code to test AllOfinlineResponse2001DataScheduleEventsItems
        expect(instance).to.be.a(LolesportsApi.AllOfinlineResponse2001DataScheduleEventsItems);
      });
