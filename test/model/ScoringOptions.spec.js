...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScoringOptions', function() {
      beforeEach(function() {
        instance = new LolesportsApi.ScoringOptions();
      });

      it('should create an instance of ScoringOptions', function() {
        // TODO: update the code to test ScoringOptions
        expect(instance).to.be.a(LolesportsApi.ScoringOptions);
      });
