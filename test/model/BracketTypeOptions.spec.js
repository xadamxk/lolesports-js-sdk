...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BracketTypeOptions', function() {
      beforeEach(function() {
        instance = new LolesportsApi.BracketTypeOptions();
      });

      it('should create an instance of BracketTypeOptions', function() {
        // TODO: update the code to test BracketTypeOptions
        expect(instance).to.be.a(LolesportsApi.BracketTypeOptions);
      });
