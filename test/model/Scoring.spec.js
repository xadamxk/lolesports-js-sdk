...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Scoring', function() {
      beforeEach(function() {
        instance = new LolesportsApi.Scoring();
      });

      it('should create an instance of Scoring', function() {
        // TODO: update the code to test Scoring
        expect(instance).to.be.a(LolesportsApi.Scoring);
      });
